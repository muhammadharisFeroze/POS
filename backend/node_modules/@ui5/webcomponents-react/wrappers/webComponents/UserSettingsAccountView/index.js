 ...
 * @experimental
 */
const UserSettingsAccountView = withWebComponent('ui5-user-settings-account-view', ['text'], ['secondary', 'selected', 'showManageAccount'], ['account'], ['edit-accounts-click', 'manage-account-click']);
