...
interface DateTimePickerPropTypes extends DateTimePickerAttributes, Omit<CommonProps, keyof DateTimePickerAttributes | 'valueStateMessage' | 'onChange' | 'onClose' | 'onInput' | 'onOpen' | 'onValueStateChange'> {
    /**
 ...
 */
declare const DateTimePicker: import("react").ForwardRefExoticComponent<DateTimePickerPropTypes & import("@ui5/webcomponents-react-base").WithWebComponentPropTypes & import("react").RefAttributes<DateTimePickerDomRef>>;
