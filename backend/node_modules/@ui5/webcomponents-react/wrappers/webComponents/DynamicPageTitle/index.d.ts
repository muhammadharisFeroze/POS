...
interface DynamicPageTitlePropTypes extends DynamicPageTitleAttributes, Omit<CommonProps, 'actionsBar' | 'breadcrumbs' | 'children' | 'heading' | 'navigationBar' | 'snappedHeading' | 'snappedSubheading' | 'snappedTitleOnMobile' | 'subheading'> {
    /**
 ...
 */
declare const DynamicPageTitle: import("react").ForwardRefExoticComponent<DynamicPageTitlePropTypes & import("@ui5/webcomponents-react-base").WithWebComponentPropTypes & import("react").RefAttributes<DynamicPageTitleDomRef>>;
