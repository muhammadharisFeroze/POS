 ...
 * @experimental
 */
const UserSettingsAppearanceViewGroup = withWebComponent('ui5-user-settings-appearance-view-group', ['headerAccessibleName', 'headerText', 'wrappingType'], [], ['header'], ['move-over', 'move']);
