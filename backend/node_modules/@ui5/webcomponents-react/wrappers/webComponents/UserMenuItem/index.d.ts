...
import type { MenuBeforeCloseEventDetail, MenuBeforeOpenEventDetail, MenuItemAccessibilityAttributes } from '@ui5/webcomponents/dist/MenuItem.js';
...
interface UserMenuItemPropTypes extends UserMenuItemAttributes, Omit<CommonProps, keyof UserMenuItemAttributes | 'children' | 'deleteButton' | 'endContent' | 'onBeforeClose' | 'onBeforeOpen' | 'onCheck' | 'onClose' | 'onDetailClick' | 'onOpen'> {
    /**
 ...
 * @experimental
 */
declare const UserMenuItem: import("react").ForwardRefExoticComponent<UserMenuItemPropTypes & import("@ui5/webcomponents-react-base").WithWebComponentPropTypes & import("react").RefAttributes<UserMenuItemDomRef>>;
export { UserMenuItem };
