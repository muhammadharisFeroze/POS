...
import type { ShellBarAccessibilityAttributes, ShellBarContentItemVisibilityChangeEventDetail, ShellBarLogoClickEventDetail, ShellBarMenuItemClickEventDetail, ShellBarNotificationsClickEventDetail, ShellBarProductSwitchClickEventDetail, ShellBarProfileClickEventDetail, ShellBarSearchButtonEventDetail, ShellBarSearchFieldClearEventDetail, ShellBarSearchFieldToggleEventDetail } from '@ui5/webcomponents-fiori/dist/ShellBar.js';
...
interface ShellBarPropTypes extends ShellBarAttributes, Omit<CommonProps, keyof ShellBarAttributes | 'assistant' | 'branding' | 'children' | 'content' | 'logo' | 'menuItems' | 'profile' | 'searchField' | 'startButton' | 'onContentItemVisibilityChange' | 'onLogoClick' | 'onMenuItemClick' | 'onNotificationsClick' | 'onProductSwitchClick' | 'onProfileClick' | 'onSearchButtonClick' | 'onSearchFieldClear' | 'onSearchFieldToggle'> {
    /**
     ...
     * | ❌|✅|
     */
    onContentItemVisibilityChange?: (event: Ui5CustomEvent<ShellBarDomRef, ShellBarContentItemVisibilityChangeEventDetail>) => void;
    /**
 ...
 */
declare const ShellBar: import("react").ForwardRefExoticComponent<ShellBarPropTypes & import("@ui5/webcomponents-react-base").WithWebComponentPropTypes & import("react").RefAttributes<ShellBarDomRef>>;
export { ShellBar };
