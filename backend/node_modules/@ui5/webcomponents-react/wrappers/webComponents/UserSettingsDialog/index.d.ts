...
interface UserSettingsDialogPropTypes extends UserSettingsDialogAttributes, Omit<CommonProps, keyof UserSettingsDialogAttributes | 'children' | 'fixedItems' | 'onBeforeClose' | 'onClose' | 'onOpen' | 'onSelectionChange'> {
    /**
 ...
 * @experimental
 */
declare const UserSettingsDialog: import("react").ForwardRefExoticComponent<UserSettingsDialogPropTypes & import("@ui5/webcomponents-react-base").WithWebComponentPropTypes & import("react").RefAttributes<UserSettingsDialogDomRef>>;
