 ...
 */
const Table = withWebComponent('ui5-table', ['accessibleName', 'accessibleNameRef', 'loadingDelay', 'noDataText', 'overflowMode', 'rowActionCount'], ['alternateRowColors', 'loading'], ['features', 'headerRow', 'noData'], ['move-over', 'move', 'row-action-click', 'row-click']);
