 ...
 * @experimental
 */
const UserSettingsDialog = withWebComponent('ui5-user-settings-dialog', ['headerText'], ['open', 'showSearchField'], ['fixedItems'], ['before-close', 'close', 'open', 'selection-change']);
