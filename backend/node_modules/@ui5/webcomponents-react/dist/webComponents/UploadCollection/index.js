 ...
 */
const UploadCollection = withWebComponent('ui5-upload-collection', ['accessibleName', 'noDataDescription', 'noDataHeaderLevel', 'noDataText', 'selectionMode'], ['hideDragOverlay'], ['header'], ['item-delete', 'selection-change']);
