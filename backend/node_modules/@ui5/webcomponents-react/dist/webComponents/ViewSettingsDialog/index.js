 ...
 */
const ViewSettingsDialog = withWebComponent('ui5-view-settings-dialog', [], ['groupDescending', 'open', 'sortDescending'], ['filterItems', 'groupItems', 'sortItems'], ['before-open', 'cancel', 'close', 'confirm', 'open']);
