 ...
 * @abstract
 */
const SideNavigationSubItem = withWebComponent('ui5-side-navigation-sub-item', ['accessibilityAttributes', 'design', 'href', 'icon', 'target', 'text', 'tooltip'], ['disabled', 'selected', 'unselectable'], [], ['click']);
