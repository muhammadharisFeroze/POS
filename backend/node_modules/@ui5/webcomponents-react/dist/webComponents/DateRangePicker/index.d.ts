...
interface DateRangePickerPropTypes extends DateRangePickerAttributes, Omit<CommonProps, keyof DateRangePickerAttributes | 'valueStateMessage' | 'onChange' | 'onClose' | 'onInput' | 'onOpen' | 'onValueStateChange'> {
    /**
 ...
 */
declare const DateRangePicker: import("react").ForwardRefExoticComponent<DateRangePickerPropTypes & import("@ui5/webcomponents-react-base").WithWebComponentPropTypes & import("react").RefAttributes<DateRangePickerDomRef>>;
