 ...
 * @experimental
 */
const UserSettingsItem = withWebComponent('ui5-user-settings-item', ['accessibleName', 'headerText', 'icon', 'loadingReason', 'text', 'tooltip'], ['disabled', 'loading', 'selected'], ['tabs'], ['selection-change']);
