 ...
 */
const NotificationListItem = withWebComponent('ui5-li-notification', ['importance', 'loadingDelay', 'state', 'titleText', 'wrappingType'], ['loading', 'read', 'showClose'], ['avatar', 'footnotes', 'menu'], ['close']);
