 ...
 */
const Slider = withWebComponent('ui5-slider', ['accessibleName', 'labelInterval', 'max', 'min', 'name', 'step', 'value'], ['disabled', 'editableTooltip', 'showTickmarks', 'showTooltip'], [], ['change', 'input']);
