 ...
 */
const RangeSlider = withWebComponent('ui5-range-slider', ['accessibleName', 'endValue', 'labelInterval', 'max', 'min', 'name', 'startValue', 'step'], ['disabled', 'editableTooltip', 'showTickmarks', 'showTooltip'], [], ['change', 'input']);
